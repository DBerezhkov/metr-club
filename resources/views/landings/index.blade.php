...
<head>
    ...
    <title>
        ...
        @switch($landing->landing_type)
            @case(1)
                Metr.club + {{$clear_title}}
            @break
            @case(2)
                {{$clear_title}}
            @break
        ...
        <div class="index__container">
            <div class="index__content">
                <div class="content__brand-names">
                    @switch($landing->landing_type)
                        @case(1)
                            ...
                            <div class="brand__names-plus">+</div>
                                @if($splitted)
                                    <div class="brand__names-ipotekapro">{{$splitted_title[0]}}<span>{{$splitted_title[1]}}</span></div>
                                @else
                                    <div class="brand__names-ipotekapro">{{$landing->title}}</div>
                                @endif
                        @break
                        @case(2)
                            @if($splitted)
                ...
                <div class="content__text">
                    <img src="/img/landing/Line 12.svg" alt="">
                ...
                <div class="@if($landing->type == 1) content__logotypes @else content__logotypes__solo @endif">
                    @switch($landing->landing_type)
                        @case(1)
                            <div class="logotypes__metr">
                                <img src="/img/landing/metr-club.svg" alt="Metr Club">
                            </div>
                            <div class="logotypes__ipotekapro">
                                <img src="/img/landings/{{$landing->image}}" alt="{{$landing->title}}">
                            </div>
                            @break
                        @case(2)
                            <div class="logotypes__ipotekapro">
                            ...
                            @break
                        @case(3)
                            <div class="logotypes__metr" style="margin-right: 0">
                                <img src="/img/landing/metr-club.svg" alt="Metr Club">
                            </div>
                            @break
                        @default
        ...
        <div class="registration__container">
            <div class="registration__content">
                ...
                <form id="form" name="form">
                    ...
                    <div class="line-registration"><img src="/img/landing/line-registration.svg" alt=""></div>
            ...
            <div class="registration__footer">
                ...
                <div class="footer__icons">
                    <a href="https://www.facebook.com/profile.php?id=100067640635425"><img
                            src="/img/landing/icons/fb.svg" alt="" class="facebook"></a>
                    <a href="https://t.me/metrclub"><img src="/img/landing/icons/telegram.svg" alt=""
                                                         class="telegram"></a>
                    <a href="https://www.instagram.com/metr.club/"><img src="/img/landing/icons/instagram.svg" alt=""
                                                                        class="instagram"></a>
                    <a href="https://vk.com/metr.club"><img src="/img/landing/icons/vk.svg" alt="" class="vk"></a>
                    <a href="https://ok.ru/group/58794082369539"><img src="/img/landing/icons/classmate.svg" alt=""
                                                                      class="classmate"></a>
                </div>
        ...
        <div class="popup__body">
            <div class="popup__content">
                <div class="popup__icon" id="popupIcon">
                    <img src="/img/landing/icons/popup-icon.svg" alt="" id="registrationIcon">
                    <img src="/img/landing/preloader.png" alt="" id="preloader" style="margin-bottom: 100px">
                </div>
                ...
                <a href="{{ route('landing.show', $landing->slug) }}" class="popup__close close-popup" id="popupButton">Принято!</a>
            </div>
        </div>
    </div>
...
<script src="/js/landing/selector.js"></script>
<script src="/js/landing/popup.js"></script>
<script>
