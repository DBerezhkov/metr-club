            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('pages.update', $page->id) }} " method="POST" id='formSnd' enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-4">
                                        ...
                                        <input type="text" value="{{ $page->slug }}" class="form-control" id="slug" name="slug" required data-inputmask-regex='[a-zA-Z0-9\-]*' data-mask>
                                        @error('slug')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <textarea name="content" id="content" class="form-control tinyMCE" rows="50" required>{{ $page->content }}</textarea>
                                        @error('content')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
