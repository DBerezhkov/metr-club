...
@section('title', 'Редактировать шаблон письма')
...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Редактировать шаблон письма</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
            @if (session('success'))
                ...
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <div class="row justify-content-start">
                            <div class="col-md-5">
                                <form action="{{ route('demands_templates.update', $template) }}" method="POST"
                                      id='formSnd'>
                                    @csrf
                                    @method('PUT')

                                        <div class="mb-3"><b>Чтобы указать в теме или в теле письма данные заявки,
                                                клиента или агента, воспользуйтесь таблицей меток</b></div>
                                        <div class="form-group col-md-10 pl-0">
                                            <label for="exampleInputPassword1">Наименование шаблона</label>
                                            <input type="text" value="{{old('name') ?? $template->name }}"
                                        ...
                                        <div class="form-group col-md-10 pl-0">
                                            ...
                                            <input type="text" value="{{old('subject') ?? $template->subject }}"
                                        ...
                                        <div class="form-group col-md-10 pl-0">
                                            ...
                                            <textarea name="body" id="body" class="form-control tinyMCE" rows="10"
                                        ...
                                        <div class="form-group col-md-10 pl-0">
                                            ...
                                            <textarea name="refin_body" id="refin_body" class="form-control tinyMCE"
                                                      rows="10">{!! old('refin_body') ?? $template->refin_body !!}</textarea>
                                            @error('refin_body')
                                            <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
                                        <div class="form-group clearfix">
                                            <div class="icheck-primary d-inline">
                                                <input type="checkbox" class="form-control" id="enabled" name="enabled"
                                                       value="1" {{$template->enabled == 1 ? 'checked' : ''}}
                                                       @if($template->id == 1) disabled @endif>
                                                <label for="enabled">
                                                    Включен
                                                </label>
                                            </div>
                                        </div>
                                        <button type="submit" id="btnSubmit" class="btn btn-success">Обновить шаблон
                                        </button>
                                    <!-- /.card-body -->
