            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="card card-primary">
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('reward_credits.store') }} " method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <label for="description">Описание</label>
                                    <textarea name="description" class="tiny" id="" cols="80" rows="5">{{ old('description') }}</textarea>
                                    @error('description')
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="advanced_description" class="tiny" id="" cols="80" rows="5">{{ old('advanced_description') }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control tiny" id="email-bank" name="mail_for_demands">{{old('mail_for_demands')}}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea type="text" class="form-control tiny" id="email-copy-bank" name="curator" >{{old('curator')}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="lk">Личный кабинет</label>
                                    <textarea name="lk" class="tiny" id="" cols="80" rows="5">{{ old('lk') }}</textarea>
                                </div>

                                <div class="form-group">
                                    <label for="bank_contacts">Контакты банка по заявке</label>
                                    <textarea name="bank_contacts" class="tiny" id="" cols="80" rows="5"></textarea>
                                </div>
                                <div class="form-group">
                                    ...
                                    <textarea name="text" id="" class="tiny" cols="80" rows="5"></textarea>
                                </div>
                                <div class="form-group">
