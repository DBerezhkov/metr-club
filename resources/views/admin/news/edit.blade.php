            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('news.update', $news->id) }} " method="POST" id='formSnd' enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" value="{{ $news->annotation }}" class="form-control" id="annotation" name="annotation" required>
                                        @error('annotation')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <textarea name="article_text" id="article_text" class="form-control">{{ $news->article_text }}</textarea>
                                        @error('article_text')
                                        <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
                                </div>
                                <button type="submit" id="btnSubmit" class="btn btn-success">Обновить новость</button>
                            </div>
                            <!-- /.card-body -->
