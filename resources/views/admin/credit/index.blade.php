...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="ml-2">Все заявки на потребы</h1>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
    </div>
            ...
            <div class="accordion px-2" id="accordionExample">
                <div class="card">
                    <div class="card-header border-0 py-1">
                        <div class="form-row">
                                <div class="col-auto">
                                    <form action="{{route('creditsExport')}}">
                        ...
                        <div id="collapseTwo"
                            ...
                            <div class="card-body py-2">
                                <form action="{{route('credit.index')}}">
                                    <div class="form-row mb-3">
                                        <div class="col-auto">
                                            ...
                                            <input name="search_field"
                                                   ...
                                                   data-toggle="tooltip" title="Введите одно из значений: ФИО или контактный телефон или имя сотрудника"
                                        ...
                                        <div class="col-auto" style="padding-top: 31px">
                                            @if(request()->get('search_field') || request()->get('name_of_banks') || request()->get('create_date_range') !== null && !empty($_GET))
                                                    <a href="{{route('credit.index')}}" class="btn btn-success">Сбросить</a>
                                            @endif
                                        </div>
                                    </div>
                                    @if(request()->get('search_field') || request()->get('name_of_banks') || request()->get('create_date_range') !== null && !empty($_GET))
                        ...
                        <table class="table table-striped projects">
                            ...
                            @foreach($credits as $credit)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($credit->agent)
                                            <a href="/admin_panel/users/{{  $credit->agent_id }}">{{ $credit->agent['name'] }}</a> ({{ $credit->agent['email'] }})
                                        @endif
                                    </td>
                                    <td>
                                        {{ $credit['created_at'] }}
